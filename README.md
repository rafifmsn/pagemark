...
> Install it through the **[Chrome Web Store](https://chromewebstore.google.com/detail/pagemark/dpnfgohhgehakmknbnpgojaalglhaeej)**, or download it directly from the **[latest release](https://github.com/Ademking/MD-This-Page/releases/tag/1.0.0)**.
